...
-- =============================================
-- Sample slots for testing (optional — remove for production)
-- Uncomment to insert test slots with WhatsApp links
-- =============================================
/*
INSERT INTO slots (date, time_label, capacity, entry_fee, status, whatsapp_link) VALUES
  (CURRENT_DATE + 1, '1:00 PM – 3:00 PM', 20, 50, 'open', 'https://chat.whatsapp.com/test_link_1'),
  (CURRENT_DATE + 1, '5:00 PM – 7:00 PM', 20, 50, 'open', 'https://chat.whatsapp.com/test_link_2'),
  (CURRENT_DATE + 2, '1:00 PM – 3:00 PM', 20, 50, 'open', 'https://chat.whatsapp.com/test_link_3'),
  (CURRENT_DATE + 2, '6:00 PM – 8:00 PM', 20, 50, 'open', 'https://chat.whatsapp.com/test_link_4')
